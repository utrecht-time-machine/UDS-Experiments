...
<a title="alles van het trefwoord <%response.write trefwoord%>" target="_top" href="/uds4/zoekpagina3t.asp?search=<%response.write trefwoord%>"><%response.write trefwoord%></a>
 ...
 <!--/boven -->
    <iframe style="width:1000px;height:649px" FRAMEBORDER=0 scrolling=no src="/data/ZoekplaatDb/ZplaatHUA/ZplaatHUA.catnr.818061/ZplaatHUA.catnr.818061-links.htm"></iframe>
